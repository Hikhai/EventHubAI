...
<section class="hero-section">
    ...
    <div class="container">
        ...
        <%-- Search form --%>
        <form method="get"
              action="${pageContext.request.contextPath}/events"
              class="hero-search"
              data-aos="fade-up"
              data-aos-delay="200">
                            ...
                            <div class="event-card-body">
                                ...
                                <p class="event-card-summary">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <c:if test="${fn:length(event.description) > 150}">
                                                ...
                                            </c:if>
                                        </c:otherwise>
                                    </c:choose>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-1">
                                    <small class="text-muted">
                                        ...
                                        <%-- Trạng thái ưu tiên của event đối với tài khoản hiện tại --%>
                                    <c:set var="myRegistrationStatus"
                                           value="${registrationStatusByEvent[event.eventId]}"/>
                                    ...
                                    <c:choose>
                                        ...
                                        <%-- Sự kiện đã kết thúc --%>
                                        <c:when test="${event.ended or event.status == 'COMPLETED'}">
                                            <c:choose>
                                                <c:when test="${myRegistrationStatus == 'REGISTERED'}">
                                                    <span class="badge-status badge-attended">
                                                        Đã tham gia
                                                    </span>
                                                </c:when>
                                        ...
                                        <c:when test="${myRegistrationStatus == 'REGISTERED'}">
                                            <span class="badge-status badge-registered">
                                                Đã đăng ký
                                            </span>
                                        </c:when>

                                        <%-- Tài khoản đã hủy đăng ký --%>
                                        <c:when test="${myRegistrationStatus == 'CANCELLED'}">
                                            <span class="badge-status badge-cancelled">
                                                Đã hủy đăng ký
                                            </span>
                                        </c:when>
                ...
                <c:forEach var="rec"
                    ...
                    <div class="col-md-4">
                        <div class="event-card">
                            ...
                            <div class="event-card-image">
                                <img src="${pageContext.request.contextPath}${rec.displayImagePath}"
                                     alt="${rec.title}"
                                     onerror="this.src='${pageContext.request.contextPath}/uploads/defaults/default_other.jpg'">
